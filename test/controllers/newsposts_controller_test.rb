...
class NewspostsControllerTest < ActionController::TestCase
  ...
  test "should create newspost" do
    assert_difference('Newspost.count') do
      post :create, newspost: { content: @newspost.content, date_posted: @newspost.date_posted, poster: @newspost.poster }
    end
  ...
  test "should update newspost" do
    patch :update, id: @newspost, newspost: { content: @newspost.content, date_posted: @newspost.date_posted, poster: @newspost.poster }
    assert_redirected_to newspost_path(assigns(:newspost))
  end
